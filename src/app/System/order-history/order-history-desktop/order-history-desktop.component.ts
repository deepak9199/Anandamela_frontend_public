...
import {
  ...
  OrderDetail,
  OrderHistory,
} from 'src/app/Model/orderhistory';
...
@Component({
  selector: 'app-order-history-desktop',
  templateUrl: './order-history-desktop.component.html',
  styleUrls: ['./order-history-desktop.component.css'],
})
export class OrderHistoryDesktopComponent {

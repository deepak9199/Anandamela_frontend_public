...
@Component({
  selector: 'app-furniture-mobile',
  templateUrl: './furniture-mobile.component.html',
  styleUrls: ['./furniture-mobile.component.css'],
})
export class FurnitureMobileComponent {
  loading: boolean = true;
  furniturehomepagedata: HomePageData;
      ...
      .subscribe({
        next: (data: HomePageApi) => {
          if (data.msg == 'Successful') {
            this.furniturehomepagedata = data.data;
            ...
            this.toster.error(data.msg, 'getHomePageData() function');
          }
        },
        error: (err) => {
          // this.geterror()
  ...
  addtowishlist(id: number, index: number, type: string) {
    ...
    if (type === 'tp') {
      let obj: TrendingProduct =
        this.furniturehomepagedata.trending_products[index];
      obj.is_wishlist = '1';
      this.furniturehomepagedata.trending_products[index] = obj;
    } else if (type === 'fp') {
      let obj: FeaturedProduct =
        this.furniturehomepagedata.featured_products[index];
      obj.is_wishlist = '1';
      this.furniturehomepagedata.featured_products[index] = obj;
    }
  }
  // scrole
  private scrole() {

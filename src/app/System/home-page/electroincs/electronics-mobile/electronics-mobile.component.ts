...
import { Brand, BrandApi, BrandData } from 'src/app/Model/brands';
import { AddToCartModel } from 'src/app/Model/cart';
import { Category, categoriesApi } from 'src/app/Model/categories';
import {
  HomePageMenuItem,
  HomePageApi,
  HomePage,
...
@Component({
  selector: 'app-electronics-mobile',
  templateUrl: './electronics-mobile.component.html',
  styleUrls: ['./electronics-mobile.component.css'],
})
export class ElectronicsMobileComponent {

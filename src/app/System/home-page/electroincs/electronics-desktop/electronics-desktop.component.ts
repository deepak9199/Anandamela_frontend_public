...
@Component({
  selector: 'app-electronics-desktop',
  templateUrl: './electronics-desktop.component.html',
  styleUrls: ['./electronics-desktop.component.css'],
})
export class ElectronicsDesktopComponent {
